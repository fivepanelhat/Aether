...
description: Enforce NZ Start-Up agent autonomy ceilings, secret refusal, path sandboxing, watermarks, tool-use discipline, refusal calibration, extended thinking, and FACT/INFERENCE/UNKNOWN labels to reduce hallucination. Load before fleet work.
metadata:
  version: "1.1.0"
  status: active
